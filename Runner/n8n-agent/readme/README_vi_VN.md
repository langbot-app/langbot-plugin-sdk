...
- **Phiên bản**: `0.1.2`
- **Kho mã nguồn**: [https://github.com/langbot-app/langbot-plugins/tree/main/Runner/n8n-agent](https://github.com/langbot-app/langbot-plugins/tree/main/Runner/n8n-agent)
...
| `response-handling` (`reply` / `ignore`) | `select` | Không | `reply` |
| `basic-encoding` (`utf-8` / `latin1`) | `select` | Không | `utf-8` |
