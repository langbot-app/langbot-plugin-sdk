...
- **版本**: `0.1.2`
- **程式碼儲存庫**: [https://github.com/langbot-app/langbot-plugins/tree/main/Runner/n8n-agent](https://github.com/langbot-app/langbot-plugins/tree/main/Runner/n8n-agent)
...
| `response-handling` (`reply` / `ignore`) | `select` | 否 | `reply` |
| `basic-encoding` (`utf-8` / `latin1`) | `select` | 否 | `utf-8` |
