...
class EventLoopLagMonitor:
    ...
    async def _run(self) -> None:
        ...
        while True:
            ...
            # Do not replay every missed interval after one long stall. One
            # measured lag already captures the stall and the next sample
            # should represent a fresh interval.
