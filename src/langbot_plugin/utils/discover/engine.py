...
class ComponentDiscoveryEngine:
    ...
    def load_component_manifest(self, path: str, owner: str = 'builtin', no_save: bool = False) -> ComponentManifest | None:
        """加载组件清单"""
    ...
    def find_components(self, kind: str, component_list: typing.List[ComponentManifest]) -> typing.List[ComponentManifest]:
        """查找组件"""
