...
from langbot_plugin.api.definition.abstract.platform.adapter import AbstractMessagePlatformAdapter
from langbot_plugin.api.definition.abstract.platform.event_logger import AbstractEventLogger
from typing import Optional, List

class MockLogger(AbstractEventLogger):
    async def info(self, text: str, images: Optional[List[Image]] = None, message_session_id: Optional[str] = None, no_throw: bool = True):
        pass
    async def debug(self, text: str, images: Optional[List[Image]] = None, message_session_id: Optional[str] = None, no_throw: bool = True):
        pass
    async def warning(self, text: str, images: Optional[List[Image]] = None, message_session_id: Optional[str] = None, no_throw: bool = True):
        pass
    async def error(self, text: str, images: Optional[List[Image]] = None, message_session_id: Optional[str] = None, no_throw: bool = True):
        pass
...
def test_person_message_received():
    ...
    serialized = model.model_dump()
    # 反序列化时补回 adapter 字段
    serialized["query"]["adapter"] = MockAdapter(bot_account_id="bot", config={}, logger=MockLogger())
